...
; CHECK-NEXT: call void @llvm.memcpy.p0i8.p1i8.i64
; CHECK: in function reject_as1_source_memcpy_ref_payload
define void @reject_as1_source_memcpy_ref_payload(
...
entry:
  ...
  call void @llvm.memcpy.p0i8.p1i8.i64(i8* %dst.i8, i8 addrspace(1)* %src.i8,
                                       i64 16, i1 false)
  ret void
}
