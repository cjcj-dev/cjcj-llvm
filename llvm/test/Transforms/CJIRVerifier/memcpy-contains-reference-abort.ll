...
; CHECK: in function abort_contains_reference_memcpy
define void @abort_contains_reference_memcpy(%payload addrspace(1)* %dst) gc "cangjie" {
entry:
  ...
  call void @llvm.memcpy.p1i8.p0i8.i64(i8 addrspace(1)* %dst.i8, i8* %src.i8, i64 16, i1 false)
  ret void
}
