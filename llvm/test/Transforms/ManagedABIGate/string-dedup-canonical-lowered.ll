...
declare i8 addrspace(1)* @CJ_MCC_StringDedupCanonical(i8*, i8 addrspace(1)*)

define void @dedup_lowered(i8* %ti, i8 addrspace(1)* %candidate) gc "cangjie" {
entry:
  %backing = call i8 addrspace(1)* @CJ_MCC_StringDedupCanonical(i8* %ti, i8 addrspace(1)* %candidate)
  ret void
}
