...
entry:
  %token = call token (...) @llvm.cj.gc.statepoint(i64 0, i32 0, i8 addrspace(1)* (i8*, i64)* @CJ_MCC_NewArray64, i32 2, i32 0, i8* %type, i64 8190)
...
declare i8 addrspace(1)* @CJ_MCC_NewArray64(i8*, i64)
