...
entry:
  %token = call token (...) @llvm.cj.gc.statepoint(i64 0, i32 0, i8 addrspace(1)* (i8*, i64)* @CJ_MCC_NewFinalizer, i32 2, i32 0, i8* %type, i64 64)
...
declare i8 addrspace(1)* @CJ_MCC_NewFinalizer(i8*, i64)
