...
entry:
  %token = call token (...) @llvm.cj.gc.statepoint(i64 0, i32 0, i8 addrspace(1)* (i8*, i64, i1)* @CJ_MCC_NewPinnedObject, i32 3, i32 0, i8* %type, i64 64, i1 false)
...
; CHECK-NOT: cj.loadbadmask
; CHECK-NOT: CJ_MCC_ReadRefField
; CHECK: lshr i64
...
declare i8 addrspace(1)* @CJ_MCC_NewPinnedObject(i8*, i64, i1)
