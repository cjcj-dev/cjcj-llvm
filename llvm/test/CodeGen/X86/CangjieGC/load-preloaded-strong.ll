...
define i8 addrspace(1)* @strong(i8 addrspace(1)* %base, i8 addrspace(1)* addrspace(1)* %slot) gc "cangjie" {
; CHECK-LABEL: define i8 addrspace(1)* @strong(
...
; CHECK: loadAccessor:
; CHECK-NEXT: [[NATIVE:%[^ ]+]] = call i8 addrspace(1)* @CJ_MCC_ReadRefField(i8 addrspace(1)* %base, i8 addrspace(1)* addrspace(1)* %slot)
; CHECK: loadFinish:
