...
define i8 addrspace(1)* @probe(i8* %type, i8 addrspace(1)* %value, i64* %alias, i64 %word, i8 addrspace(1)* %unknown) gc "cangjie" {
entry:
  ...
  %field = getelementptr inbounds i8, i8 addrspace(1)* %unknown, i64 8
