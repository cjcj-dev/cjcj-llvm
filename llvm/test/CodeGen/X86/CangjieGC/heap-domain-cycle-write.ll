...
exit:
  ...
  call void (i8 addrspace(1)*, i8 addrspace(1)*, i8 addrspace(1)* addrspace(1)*, ...) @llvm.cj.gcwrite.ref(i8 addrspace(1)* %value, i8 addrspace(1)* %iteration, i8 addrspace(1)* addrspace(1)* %slot, i32 1)
  ret void
}
