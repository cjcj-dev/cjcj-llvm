...
entry:
  %token = call token (...) @llvm.cj.gc.statepoint(i64 0, i32 0, i8 addrspace(1)* (i8*, i64, i64)* @CJ_MCC_NewArray16, i32 3, i32 0, i8* %type, i64 32760, i64 poison)
...
declare i8 addrspace(1)* @CJ_MCC_NewArray16(i8*, i64, i64)
