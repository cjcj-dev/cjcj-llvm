...
entry:
  ...
  %safepoint = call token (...) @llvm.cj.gc.statepoint(i64 1, i32 0, void ()* @safepoint, i32 0, i32 0) [ "gc-live"(i8 addrspace(1)* %heap, i8 addrspace(1)* %heap) ]
  %relocated = call i8 addrspace(1)* @llvm.cj.gc.relocate.p1i8(token %safepoint, i32 0, i32 1)
  %field = getelementptr inbounds i8, i8 addrspace(1)* %relocated, i64 8
  %slot = bitcast i8 addrspace(1)* %field to i8 addrspace(1)* addrspace(1)*
  call void (i8 addrspace(1)*, i8 addrspace(1)*, i8 addrspace(1)* addrspace(1)*, ...) @llvm.cj.gcwrite.ref(i8 addrspace(1)* %value, i8 addrspace(1)* %relocated, i8 addrspace(1)* addrspace(1)* %slot, i32 1)
  ret void
}
