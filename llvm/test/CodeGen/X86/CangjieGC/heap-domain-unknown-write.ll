...
entry:
  %field = getelementptr inbounds i8, i8 addrspace(1)* %arg, i64 8
  %slot = bitcast i8 addrspace(1)* %field to i8 addrspace(1)* addrspace(1)*
  call void (i8 addrspace(1)*, i8 addrspace(1)*, i8 addrspace(1)* addrspace(1)*, ...) @llvm.cj.gcwrite.ref(i8 addrspace(1)* %value, i8 addrspace(1)* %arg, i8 addrspace(1)* addrspace(1)* %slot, i32 1)
  ret void
}
