...
entry:
  %token = call token (...) @llvm.cj.gc.statepoint(i64 0, i32 0, i8 addrspace(1)* (i8*, i64)* @CJ_MCC_NewArray, i32 2, i32 0, i8* bitcast ({ i8*, i8, i8, i16, i32, i8*, i64, i8, i8, i16, i8*, i8*, i8*, i8*, i8* }* @array_ti to i8*), i64 8190)
