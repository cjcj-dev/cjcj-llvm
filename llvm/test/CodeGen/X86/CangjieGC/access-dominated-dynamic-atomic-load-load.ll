...
define i8 addrspace(1)* @probe(i8* %type, i8 addrspace(1)* %value, i64* %alias, i64 %word, i32 %order) gc "cangjie" {
entry:
  ...
  %first = call i8 addrspace(1)* @llvm.cj.atomic.load(i8 addrspace(1)* %heap, i8 addrspace(1)* addrspace(1)* %slot, i32 %order)
